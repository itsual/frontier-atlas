...
Frontier Atlas only cites vendor documentation and the four cheat sheets that seeded the repo. Retrieval date: **22 August 2026**.

## Seed cheat sheets

These files were the original compilation. Facts in the guides were checked against the primary URLs below; Gemini was updated from an older 1.5 / 2.0 sheet to the Gemini 3 family using Google’s own pages.

- GPT Model × Reasoning-Effort Cheat Sheet (22 August 2026)
...
- [Grok models & pricing](https://docs.x.ai/developers/models)
